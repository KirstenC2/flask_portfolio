...
from . import health,auth, skills, education, life_events,study, experience, dev_tasks, templates,warboard, motor, incomes, savings, recurring_expenses, quotation, projects, expenses